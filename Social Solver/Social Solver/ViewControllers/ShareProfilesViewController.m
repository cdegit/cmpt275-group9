...
// Version 2
//
// Displays a collection of the child profiles this user has access to
// Allows user to select 1 or more child profiles and share it with another user
// Selecting share without selecting any users will display an error
